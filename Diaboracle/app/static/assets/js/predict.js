function drawAnswer(risque) {
    (function (factory) {
      ...
      document.querySelector("#answerPredict").innerHTML = "";
      gaugeGradeChartInit();
    });
  }
...
app = Vue.createApp({
    ...
    methods: {
        async predict_diabete(){
            await axios.get("/predict_diabete_api?age="+this.age+"&poids="+this.poids+"&taille="+this.taille+"&glycemie="+this.glycemie+"&etat_de_grossesse="+this.enceinte )
            .then(response => {
